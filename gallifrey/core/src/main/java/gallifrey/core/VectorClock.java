...
public class VectorClock implements Serializable, Comparable<VectorClock> {
    ...
    CloseableRWLocks rwlock = new CloseableRWLocks();

    public Long get(String key) {
        try (CloseableRWLocks.AcquiredLock locked = rwlock.read_lock()) {
    ...
    public void updateClock(VectorClock c) {
        try (CloseableRWLocks.AcquiredLock locked = rwlock.write_lock()) {
